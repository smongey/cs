    ...
    buildcontrol: {
      dist: {
        options: {
          ...
          remote: 'git@github.com:smongey/cs.git',
          branch: 'gh-pages'
        }
      }
    },
      ...
      dist: {
        options: {
          patterns: [
            {
              match: /("|'?)\/?styles\//g,
              replacement: '$1http://smongey.github.io/cs/styles/'
            },
            {
              match: /("|'?)\/?scripts\//g,
              replacement: '$1http://smongey.github.io/cs/scripts/'
            },
            {
              match: /(<a[^>]*href="?)(\/)/g,
              replacement: '$1http://smongey.github.io/cs/'
            },
            {
              match: /(<form[^>]*action="?)(\/)/g,
              replacement: '$1http://smongey.github.io/cs/'
